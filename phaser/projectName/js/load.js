...
Load.prototype = {
	...
	preload: function() {
		...
		game.load.images(['mainMenu','levelMenu','credits','BG', 'Ice-BG','hot', 'cold','rocket'],['mainMenu.png','levelMenu.png', 'citation.png','volcano_theme.png','ice_theme.png','Hot.png','Cold.png','rocket.png']);
